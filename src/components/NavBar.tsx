...
const NavBar = ({ setSelectedSection }: { setSelectedSection: (section: string) => void }) => {
  return (
    <div className="w-16 bg-blue-500 text-white flex flex-col items-center py-6 space-y-6">
      <button data-tooltip-id="tooltip-profile" data-tooltip-content="Profile" className="focus:outline-none">
      ...
      <button data-tooltip-id="tooltip-friends" data-tooltip-content="Friends" onClick={() => setSelectedSection('friends')} className="focus:outline-none">
